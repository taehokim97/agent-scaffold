...
EXPECTED_WHEEL_MEMBERS = [
    ...
    "agent_scaffold/source-structure/common/.claude/commands/thk-bootstrap.md",
    "agent_scaffold/source-structure/common/.claude/commands/thk-spec.md",
    "agent_scaffold/source-structure/common/.claude/commands/thk-ship.md",
    "agent_scaffold/source-structure/common/.claude/commands/thk-research.md",
    ...
    "agent_scaffold/source-structure/common/.claude/agents/second-opinion.md",
